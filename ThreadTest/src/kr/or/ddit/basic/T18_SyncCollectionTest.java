...
*/
	...
	// 동기화 하는 경우
	//Collection 객체들은 동기화 처리가 안되어있으므로 Collections 클래스에서 static으로 제공된 메서드를 사용하여 동기화를 할 수 있음
	private static List<Integer> list2 = Collections.synchronizedList(new ArrayList<>());//객체를 만들어서 동기화를 함.
